...
Uncertainty in Bayesian statistics is fundamentally different from uncertainy in frequentist statistics.  In frequentist statistics, uncertainty is commonly represented as a 95\% confidence interval, within which 95\% of estimates are assumed to fall in hypothetical replications.  The frequentist confidence interval relies on many assumptions and is often misinterpretted \citeA{hoekstra2014robust}.  In Bayesian statistics, posterior distributions are derived by multiplying prior and likelihood distributions, and thus have full probability distributions rather than point estimates with confidence intervals.  The Bayesian approach does not rely on asymptotics or assumptions about the distribution of error terms; it models uncertainty explicitly.
