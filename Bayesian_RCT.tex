...
Perhaps the greatest advantage of Bayesian modeling is its ability to capture heterogeneity in the sample and provide treatment effects that account for this heterogeneity. For example in our study, we control for variation in sex, demographics and importantly, variation in the treatment across the time period of the treatment. This type of approach is commonly known as a varying slope - varying intercept model [CITE GELMAN HILL CH 23, bottom page 506]. Our approach of hierarchical modeling and partial pooling allows us to accomplish this. This is one of the greatest advantages of BDA as a method. \\
